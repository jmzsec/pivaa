    ...
    stages {
		...
		stage ('MobSF') {
			steps {
				...
				sh "curl -X POST  http://localhost:8000/api/v1/scan '{--data scan_type=apk & file_name=pivaa.apk & hash=$(cat hash.txt)}' -H "X-Mobsf-Api-Key:8176dec5ce2b50f71eb7759b43439b69eac8bdca572b686d7741abf0c14ff239""""
